...
//
//    private String getRankingKey(Category category) {
//        return "page:ranking:" + category.name().toLowerCase();
//    }
//
//    // 좋아요 추가
//    public void likePage(Long pageId, Category category) {
//        ZSetOperations<String, String> zSetOps = redisTemplate.opsForZSet();
//        zSetOps.incrementScore(getRankingKey(category), pageId.toString(), 1);
//    }
//
//    // 좋아요 제거
...
//
//    // 카테고리별 상위 N개의 포스트 조회
//    public Set<String> getTopPages(String categoryCode, int topN) {
//        Category category = Category.getByCode(categoryCode);
//        ZSetOperations<String, String> zSetOps = redisTemplate.opsForZSet();
//        return zSetOps.reverseRange(getRankingKey(category), 0, topN - 1);
//    }
//
